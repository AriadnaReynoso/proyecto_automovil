...
function Header({cart, removeFromCart, decreaseQuantity, increaseQuantity, clearCart , suma}) {
                  ...
                  <div id="carrito-content" className="carrito-content">
                    ...
                    ( 
                      <>               
                          ...
                          <tbody> 
                            {cart.map((id, name, image, price, quantity) => (                     
                              <tr
                                ...
                                <td className="fw-bold align-middle">$ {price}</td>
                                <td className="align-middle">
                        ...
                        <p className="text-end">Total a pagar: <span className="fw-bold">$ {suma.toLocaleString()}</span></p>
                      </>  
                      )}
                    <button 
